...
public class ConfigLoader {
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        emojiList = configuration.getStringList("emojiList", Configuration.CATEGORY_GENERAL, new String[]{"1:65537:32:32:png", "2:65538:16:16:png","wd/6:65539:8:8:png","dbc/73:65540:16:16:png","gif/Run:65541:16:16:gif:10","gif/Run2:65542:16:16:gif:10"}, "自定义表情列表 - 表情名:表情索引:显示的宽度:显示的高度:类型:(如果是gif需要填帧率)");
