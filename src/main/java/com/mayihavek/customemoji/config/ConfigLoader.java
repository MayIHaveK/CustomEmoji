...
public class ConfigLoader {
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        emojiList = configuration.getStringList("emojiList", Configuration.CATEGORY_GENERAL, new String[]{"emoji_01:65537", "emoji_02:65538"}, "自定义表情列表 - 表情名:表情索引");
        judgeChar = configuration.getString("judgeChar", Configuration.CATEGORY_GENERAL, ":", "判断字符 - 用于判断是否为表情符号");
        OffsetX = configuration.getFloat("OffsetX", Configuration.CATEGORY_GENERAL, 0.0f, -100.0f, 100.0f, "自定义表情偏移 - X轴");
        OffsetY = configuration.getFloat("OffsetY", Configuration.CATEGORY_GENERAL, 1.0f, -100.0f, 100.0f, "自定义表情偏移 - Y轴");
